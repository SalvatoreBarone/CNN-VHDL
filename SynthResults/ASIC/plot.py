...
def plot_bar(data, ylabel, pdf_file):
    ...
    plt.legend(lines, ('Conv1', 'Conv2', 'Conv3', 'FC1', 'FC2'), frameon=False, bbox_to_anchor=(.5, 1.1), loc='upper center', ncol=5)
...
plot_bar(data, 'Circuit Area (um²)', 'lenet5_area.pdf')
data = np.genfromtxt('summary.csv', delimiter=';', usecols=(5,6,7,8,9), skip_header=1)
plot_bar(data, 'Power Consumption (nW)', 'lenet5_power.pdf')

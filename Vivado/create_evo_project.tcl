...
set script_file "create_evo_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/evoneuron"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xcvu29p-fsga2577-2L-e
...
set_property -name "board_part" -value "xilinx.com:vcu129:part0:1.0" -objects $obj
...
set_property -name "platform.board_id" -value "vcu129" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/mul16s_G7F.v"]\
 [file normalize "${origin_dir}/mul16s_G7Z.v"]\
 [file normalize "${origin_dir}/mul16s_G80.v"]\
 [file normalize "${origin_dir}/mul16s_GAT.v"]\
 [file normalize "${origin_dir}/mul16s_GK2.v"]\
 [file normalize "${origin_dir}/mul16s_HDG.v"]\
 [file normalize "${origin_dir}/mul16s_HEB.v"]\
 [file normalize "${origin_dir}/mul16s_HFZ.v"]\
 [file normalize "${origin_dir}/mul16s_HHP.v"]\
 [file normalize "${origin_dir}/activation.vhd"]\
 [file normalize "${origin_dir}/adder.vhd"]\
 [file normalize "${origin_dir}/data_types.vhd"]\
 [file normalize "${origin_dir}/evo_mul16s.vhd"]\
 [file normalize "${origin_dir}/utils.vhd"]\
 [file normalize "${origin_dir}/evo_weighted_sum.vhd"]\
 [file normalize "${origin_dir}/full_adder.vhd"]\
 [file normalize "${origin_dir}/generic_register.vhd"]\
 [file normalize "${origin_dir}/pipe_delay.vhd"]\
 [file normalize "${origin_dir}/piped_adder.vhd"]\
 [file normalize "${origin_dir}/sum_reduct.vhd"]\
 [file normalize "${origin_dir}/wired_shift.vhd"]\
 [file normalize "${origin_dir}/evo_neuron.vhd"]\
 [file normalize "${origin_dir}/tb_evo_neuron_4dpa.vhd"]\
]
...
set file "tb_evo_neuron_4dpa.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "evo_neuron" -objects $obj
...
set_property -name "xsim.simulate.saif" -value "tb_evo_neuron_4dpa.saif" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu29p-fsga2577-2L-e -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu29p-fsga2577-2L-e -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
